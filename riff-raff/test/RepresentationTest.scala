...
class RepresentationTest extends FlatSpec with ShouldMatchers with Utilities with PersistenceTestInstances {
  ...
  it should "not change without careful thought and testing of migration" ignore {
    ...
    val messageJsonMap = Map(
      deploy -> """{ "deploy" : { "$uuid" : "90013e69-8afc-4ba2-80a8-d7b063183d13"} , "id" : "4ef18506-3b38-4235-9933-d7da831247a6" , "parent" : "4236c133-be50-4169-8e0c-096eded5bfeb" , "document" : { "_typeHint" : "persistence.DeployDocument"} , "time" : { "$date" : "2012-11-08T17:20:00.000Z"}}""",
      infoMsg -> """{ "deploy" : { "$uuid" : "90013e69-8afc-4ba2-80a8-d7b063183d13"} , "id" : "4ef18506-3b38-4235-9933-d7da831247a6" , "parent" : "4236c133-be50-4169-8e0c-096eded5bfeb" , "document" : { "_typeHint" : "persistence.InfoDocument" , "text" : "$ echo hello"} , "time" : { "$date" : "2012-11-08T17:20:00.000Z"}}""",
      cmdOut -> """{ "deploy" : { "$uuid" : "90013e69-8afc-4ba2-80a8-d7b063183d13"} , "id" : "4ef18506-3b38-4235-9933-d7da831247a6" , "parent" : "4236c133-be50-4169-8e0c-096eded5bfeb" , "document" : { "_typeHint" : "persistence.CommandOutputDocument" , "text" : "hello"} , "time" : { "$date" : "2012-11-08T17:20:00.000Z"}}""",
      verbose -> """{ "deploy" : { "$uuid" : "90013e69-8afc-4ba2-80a8-d7b063183d13"} , "id" : "4ef18506-3b38-4235-9933-d7da831247a6" , "parent" : "4236c133-be50-4169-8e0c-096eded5bfeb" , "document" : { "_typeHint" : "persistence.VerboseDocument" , "text" : "return value 0"} , "time" : { "$date" : "2012-11-08T17:20:00.000Z"}}""",
      finishDep -> """{ "deploy" : { "$uuid" : "90013e69-8afc-4ba2-80a8-d7b063183d13"} , "id" : "4ef18506-3b38-4235-9933-d7da831247a6" , "parent" : "4236c133-be50-4169-8e0c-096eded5bfeb" , "document" : { "_typeHint" : "persistence.FinishContextDocument"} , "time" : { "$date" : "2012-11-08T17:20:00.000Z"}}""",
      finishInfo -> """{ "deploy" : { "$uuid" : "90013e69-8afc-4ba2-80a8-d7b063183d13"} , "id" : "4ef18506-3b38-4235-9933-d7da831247a6" , "parent" : "4236c133-be50-4169-8e0c-096eded5bfeb" , "document" : { "_typeHint" : "persistence.FinishContextDocument"} , "time" : { "$date" : "2012-11-08T17:20:00.000Z"}}""",
      failInfo -> """{ "deploy" : { "$uuid" : "90013e69-8afc-4ba2-80a8-d7b063183d13"} , "id" : "4ef18506-3b38-4235-9933-d7da831247a6" , "parent" : "4236c133-be50-4169-8e0c-096eded5bfeb" , "document" : { "_typeHint" : "persistence.FailContextDocument" , "detail" : { "name" : "java.lang.RuntimeException" , "message" : "Failed" , "stackTrace" : "test.RepresentationTest.<init>(RepresentationTest.scala:184)\nsun.reflect.NativeConstructorAccessorImpl.newInstance0(Native Method)\nsun.reflect.NativeConstructorAccessorImpl.newInstance(NativeConstructorAccessorImpl.java:39)\nsun.reflect.DelegatingConstructorAccessorImpl.newInstance(DelegatingConstructorAccessorImpl.java:27)\njava.lang.reflect.Constructor.newInstance(Constructor.java:513)\njava.lang.Class.newInstance0(Class.java:355)\njava.lang.Class.newInstance(Class.java:308)\norg.scalatest.tools.ScalaTestFramework$ScalaTestRunner.run(ScalaTestFramework.scala:141)\nsbt.TestRunner.delegateRun(TestFramework.scala:62)\nsbt.TestRunner.run(TestFramework.scala:56)\nsbt.TestRunner.runTest$1(TestFramework.scala:76)\nsbt.TestRunner.run(TestFramework.scala:85)\nsbt.TestFramework$$anonfun$6$$anonfun$apply$8$$anonfun$7$$anonfun$apply$9.apply(TestFramework.scala:184)\nsbt.TestFramework$$anonfun$6$$anonfun$apply$8$$anonfun$7$$anonfun$apply$9.apply(TestFramework.scala:184)\nsbt.TestFramework$.sbt$TestFramework$$withContextLoader(TestFramework.scala:196)\nsbt.TestFramework$$anonfun$6$$anonfun$apply$8$$anonfun$7.apply(TestFramework.scala:184)\nsbt.TestFramework$$anonfun$6$$anonfun$apply$8$$anonfun$7.apply(TestFramework.scala:184)\nsbt.Tests$$anonfun$makeSerial$1$$anonfun$apply$8.apply(Tests.scala:115)\nsbt.Tests$$anonfun$makeSerial$1$$anonfun$apply$8.apply(Tests.scala:115)\nscala.collection.TraversableLike$$anonfun$map$1.apply(TraversableLike.scala:194)\nscala.collection.TraversableLike$$anonfun$map$1.apply(TraversableLike.scala:194)\nscala.collection.LinearSeqOptimized$class.foreach(LinearSeqOptimized.scala:59)\nscala.collection.immutable.List.foreach(List.scala:45)\nscala.collection.TraversableLike$class.map(TraversableLike.scala:194)\nscala.collection.immutable.List.map(List.scala:45)\nsbt.Tests$$anonfun$makeSerial$1.apply(Tests.scala:115)\nsbt.Tests$$anonfun$makeSerial$1.apply(Tests.scala:115)\nsbt.std.Transform$$anon$3$$anonfun$apply$2.apply(System.scala:47)\nsbt.std.Transform$$anon$3$$anonfun$apply$2.apply(System.scala:47)\nsbt.std.Transform$$anon$5.work(System.scala:67)\nsbt.Execute$$anonfun$submit$1$$anonfun$apply$1.apply(Execute.scala:221)\nsbt.Execute$$anonfun$submit$1$$anonfun$apply$1.apply(Execute.scala:221)\nsbt.ErrorHandling$.wideConvert(ErrorHandling.scala:18)\nsbt.Execute.work(Execute.scala:227)\nsbt.Execute$$anonfun$submit$1.apply(Execute.scala:221)\nsbt.Execute$$anonfun$submit$1.apply(Execute.scala:221)\nsbt.CompletionService$$anon$1$$anon$2.call(CompletionService.scala:26)\njava.util.concurrent.FutureTask$Sync.innerRun(FutureTask.java:303)\njava.util.concurrent.FutureTask.run(FutureTask.java:138)\njava.util.concurrent.Executors$RunnableAdapter.call(Executors.java:441)\njava.util.concurrent.FutureTask$Sync.innerRun(FutureTask.java:303)\njava.util.concurrent.FutureTask.run(FutureTask.java:138)\njava.util.concurrent.ThreadPoolExecutor$Worker.runTask(ThreadPoolExecutor.java:886)\njava.util.concurrent.ThreadPoolExecutor$Worker.run(ThreadPoolExecutor.java:908)\njava.lang.Thread.run(Thread.java:662)\n"}} , "time" : { "$date" : "2012-11-08T17:20:00.000Z"}}""",
      failDep -> """{ "deploy" : { "$uuid" : "90013e69-8afc-4ba2-80a8-d7b063183d13"} , "id" : "4ef18506-3b38-4235-9933-d7da831247a6" , "parent" : "4236c133-be50-4169-8e0c-096eded5bfeb" , "document" : { "_typeHint" : "persistence.FailContextDocument" , "detail" : { "name" : "java.lang.RuntimeException" , "message" : "Failed" , "stackTrace" : "test.RepresentationTest.<init>(RepresentationTest.scala:185)\nsun.reflect.NativeConstructorAccessorImpl.newInstance0(Native Method)\nsun.reflect.NativeConstructorAccessorImpl.newInstance(NativeConstructorAccessorImpl.java:39)\nsun.reflect.DelegatingConstructorAccessorImpl.newInstance(DelegatingConstructorAccessorImpl.java:27)\njava.lang.reflect.Constructor.newInstance(Constructor.java:513)\njava.lang.Class.newInstance0(Class.java:355)\njava.lang.Class.newInstance(Class.java:308)\norg.scalatest.tools.ScalaTestFramework$ScalaTestRunner.run(ScalaTestFramework.scala:141)\nsbt.TestRunner.delegateRun(TestFramework.scala:62)\nsbt.TestRunner.run(TestFramework.scala:56)\nsbt.TestRunner.runTest$1(TestFramework.scala:76)\nsbt.TestRunner.run(TestFramework.scala:85)\nsbt.TestFramework$$anonfun$6$$anonfun$apply$8$$anonfun$7$$anonfun$apply$9.apply(TestFramework.scala:184)\nsbt.TestFramework$$anonfun$6$$anonfun$apply$8$$anonfun$7$$anonfun$apply$9.apply(TestFramework.scala:184)\nsbt.TestFramework$.sbt$TestFramework$$withContextLoader(TestFramework.scala:196)\nsbt.TestFramework$$anonfun$6$$anonfun$apply$8$$anonfun$7.apply(TestFramework.scala:184)\nsbt.TestFramework$$anonfun$6$$anonfun$apply$8$$anonfun$7.apply(TestFramework.scala:184)\nsbt.Tests$$anonfun$makeSerial$1$$anonfun$apply$8.apply(Tests.scala:115)\nsbt.Tests$$anonfun$makeSerial$1$$anonfun$apply$8.apply(Tests.scala:115)\nscala.collection.TraversableLike$$anonfun$map$1.apply(TraversableLike.scala:194)\nscala.collection.TraversableLike$$anonfun$map$1.apply(TraversableLike.scala:194)\nscala.collection.LinearSeqOptimized$class.foreach(LinearSeqOptimized.scala:59)\nscala.collection.immutable.List.foreach(List.scala:45)\nscala.collection.TraversableLike$class.map(TraversableLike.scala:194)\nscala.collection.immutable.List.map(List.scala:45)\nsbt.Tests$$anonfun$makeSerial$1.apply(Tests.scala:115)\nsbt.Tests$$anonfun$makeSerial$1.apply(Tests.scala:115)\nsbt.std.Transform$$anon$3$$anonfun$apply$2.apply(System.scala:47)\nsbt.std.Transform$$anon$3$$anonfun$apply$2.apply(System.scala:47)\nsbt.std.Transform$$anon$5.work(System.scala:67)\nsbt.Execute$$anonfun$submit$1$$anonfun$apply$1.apply(Execute.scala:221)\nsbt.Execute$$anonfun$submit$1$$anonfun$apply$1.apply(Execute.scala:221)\nsbt.ErrorHandling$.wideConvert(ErrorHandling.scala:18)\nsbt.Execute.work(Execute.scala:227)\nsbt.Execute$$anonfun$submit$1.apply(Execute.scala:221)\nsbt.Execute$$anonfun$submit$1.apply(Execute.scala:221)\nsbt.CompletionService$$anon$1$$anon$2.call(CompletionService.scala:26)\njava.util.concurrent.FutureTask$Sync.innerRun(FutureTask.java:303)\njava.util.concurrent.FutureTask.run(FutureTask.java:138)\njava.util.concurrent.Executors$RunnableAdapter.call(Executors.java:441)\njava.util.concurrent.FutureTask$Sync.innerRun(FutureTask.java:303)\njava.util.concurrent.FutureTask.run(FutureTask.java:138)\njava.util.concurrent.ThreadPoolExecutor$Worker.runTask(ThreadPoolExecutor.java:886)\njava.util.concurrent.ThreadPoolExecutor$Worker.run(ThreadPoolExecutor.java:908)\njava.lang.Thread.run(Thread.java:662)\n"}} , "time" : { "$date" : "2012-11-08T17:20:00.000Z"}}"""
    )
